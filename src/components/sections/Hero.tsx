...
const Hero = () => {
	...
	}, [codeLines.length, codeLines.slice]);
	...
	return (
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
				...
				<div className="max-w-7xl mx-auto">
					<div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
						<div>
							...
							{/* Subheader */}
							<div
								className={`mt-6 lg:mt-8 transition-all duration-1000 delay-300 ${
									isLoaded
							...
							{/* Description */}
							<div
								className={`mt-6 max-w-2xl transition-all duration-1000 delay-500 ${
									isLoaded
										? "opacity-100 translate-y-0"
										: "opacity-0 translate-y-10"
								}`}
			...
			<button
				...
				className={`absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-text-secondary hover:text-toxic-lime transition-all duration-300 cursor-pointer ${
